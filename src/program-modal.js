...
const FOCUS_SEL = "[data-card]";
  const FOCUS_IGNORE =
  "a, [data-link-card], button:not([data-author-work]), [data-tweaks], [data-tweaks-reopen], [data-deck-tune], [data-stage-settings], [data-sound-settings], [data-open-program], [data-fly-close], [data-article-close], [data-fly-illust-close], [data-work-ig], .work-card__who, [data-work-student-prev], [data-work-student-next], [data-progress-sound], [data-img-slider], [data-img-slider-dot], [data-img-slider-dots], [data-img-slider-prev], [data-img-slider-next], [data-program-strip-prev], [data-program-strip-next], [data-author-lightbox], [data-project-viewer-root], [data-preview-media], [data-progress-video]";
  const SIDE_CHROME =
